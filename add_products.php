...
if (isset($_POST['submit'])) {
    ...
    if ($msg == '') {
        if (isset($_GET['id']) && $_GET['id'] != '') {
            $query = "UPDATE products SET `name`='$name', mrp='$mrp', rate='$rate', qty='$qty', hsn_code='$hsn_code', `status`='$status' WHERE id='$id'";
            mysqli_query($con, $query);
        } else {
            $query = "INSERT INTO products(id, `name`, mrp, rate, qty, hsn_code, `status`, created_at) VALUES (DEFAULT,'$name','$mrp','$rate','$qty','$hsn_code','$status',DEFAULT)";
            mysqli_query($con, $query);
        }
        echo "<script type='text/javascript'>";
        echo "window.location = 'products.php';";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="qty" class="form-control" placeholder="Enter Product Quantity" value="<?php echo $mrp ?>" required>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rate" class="form-control" placeholder="Enter Product Rate" value="<?php echo $rate ?>" required>
                                        </div>
                                        <div class="form-group">
