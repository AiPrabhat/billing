...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'delete') {
        ...
        $delete_sql = "delete from routes where id='$id';";
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="./routes.php"></a> Routes </li>
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <a href="./add_routes.php" class="btn btn-primary float-right">
                                <i class="fas fa-plus-circle">&nbsp;&nbsp;</i> Add Routes
                            </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
